...
{  private:
	...
	*
	*@b Complexité O(nbc³), nbc = nombre des cubes dans l'arbre
	*/
	...
	*
	*@b Complexité O(nbc), nbc = nombre de cubes dans la même pile
	*/
	...
	*
	*@b Complexité O(nbc), nbc = nombre de cubes dans l'arbre
	*/
	...
	* @pre la goutte doit au minimum avoir des coordonnées succeptible de la faire tomber sur la table
	*
	*@b Complexité O(nbc), nbc = nombre des cubes dans une pile
	*/
	...
	* @pre l'arbre de doit pas être vide et posséder au moins la "table"
	*
	*@b Complexité Θ(nbc), nbc = nombre des cubes dans une pile
	*/
